  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Я думала, что не сдам математику профиль. Но когда разобралась со структурой экзамена и начала решать по плану — всё встало на своё место. На ЕГЭ набрала 89 баллов.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Анна Ковалёва</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Выпускница 2025 года, Москва</p>
        </div>
      </div>
    </section>
  )
