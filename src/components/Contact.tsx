      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Не нашёл нужный предмет или хочешь предложить тему? Напиши нам — мы читаем все сообщения и обновляем сайт регулярно.
            </p>
            ...
            >
              <div>
                ...
                <a href="mailto:info@ege2027.ru" className="text-foreground hover:text-sage transition-colors">
                  info@ege2027.ru
                </a>
              </div>
              <div>
                <p className="text-xs tracking-widest uppercase text-muted-foreground mb-2">Локация</p>
                <p className="text-foreground">Для всей России</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Какой предмет или вопрос вас интересует?"
                  required
                />
              </div>
              <button
