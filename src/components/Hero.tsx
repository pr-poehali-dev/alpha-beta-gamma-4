  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Всё о едином государственном экзамене
        </p>
        ...
        >
          Сдай ЕГЭ 2027
          <span className="block text-sage">на максимум</span>
        </h1>
        ...
        >
          Понятные материалы по всем предметам, актуальные изменения 2027 года и пошаговый план подготовки — всё, что нужно для уверенного результата.
        </p>
